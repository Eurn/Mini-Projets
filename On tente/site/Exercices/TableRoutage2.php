    ...
    $("#valider_ligne").click(function( event ) {
        ...
        */
        ...
        if(gate=='' && dest=='' && mask=='' && flags=='' && dest==''){
            ...
            if(mask!='' && !mask.match(/^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$/)){
                champs_val=false;
    ...
    $("#correction").click(function( event ) {
        ...
        */
        if(tableRoute.length>0){
            if(tableRoute.length>=tableRouteReponse.length){ //S'il manque une ligne a l'utilisateur, on ne vérifie pas plus et on l'averti
                for(var i in tableRoute){ 
                    ...
                    */
                    ...
                    for(var j in tableRouteReponse){
                        ...
                        && tableRoute[i].mask==tableRouteReponse[j].mask
