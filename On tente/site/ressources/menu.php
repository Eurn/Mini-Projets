			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
					        ...
					        <li><a href="/CalculIP/Exercices/Conversion.php">Conversions <i><sub><small>Binaire, Hexadécimal et Décimal</small></sub></i></a></li>
			...
			<ul class="nav navbar-nav navbar-right">
			        <?php
                                        if(isset($_SESSION['connect']) && isLogin()){
                                                ...
                                                echo '
                                                        <ul class="dropdown-menu">
                                                                <li><a href="/CalculIP/Utilisateur/profil.php">Profil</a></li>
